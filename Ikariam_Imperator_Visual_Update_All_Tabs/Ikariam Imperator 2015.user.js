...
\
      #ImperatorOverviewBuildingsTable th.building_townHall { \
        background-image: url("/cdn/all/both/buildings/buildingbutton_sprite.jpg");\
...
\
      #ImperatorOverviewBuildingsTable th.building_townHall:hover {\
      background-position: 0px 0px;\
}\
\
...
\
      #ImperatorOverviewBuildingsTable th.building_academy:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_warehouse:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_tavern:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_palace:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_palaceColony:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_museum:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_port:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_shipyard:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_barracks:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_wall:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_embassy:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_branchOffice:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_workshop:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_safehouse:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_forester:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_glassblowing:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_alchemist:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_winegrower:hover {\
      background-position: -774px 0px;\
}\
\
      #ImperatorOverviewBuildingsTable th.building_stonemason { \
        background-image: url("/cdn/all/both/buildings/buildingbutton_sprite.jpg");\
        background-position: -817px -41px;\
        background-repeat: no-repeat;\
        background-size: auto;\
        width: 43px;\
        height: 43px;\
...
\
      #ImperatorOverviewBuildingsTable th.building_stonemason:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_carpentering:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_optician:hover {\
      background-position: -903px 0px;\
}\
\
      #ImperatorOverviewBuildingsTable th.building_fireworker { \
        background-image: url("/cdn/all/both/buildings/buildingbutton_sprite.jpg");\
        background-position: -946px -41px;\
        background-repeat: no-repeat;\
        background-size: auto;\
        width: 43px;\
        height: 43px;\
...
\
      #ImperatorOverviewBuildingsTable th.building_fireworker:hover {\
      background-position: -946px 0px;\
}\
\
      #ImperatorOverviewBuildingsTable th.building_vineyard { \
        background-image: url("/cdn/all/both/buildings/buildingbutton_sprite.jpg");\
        background-position: -989px -41px;\
        background-repeat: no-repeat;\
        background-size: auto;\
        width: 43px;\
        height: 43px;\
...
\
      #ImperatorOverviewBuildingsTable th.building_vineyard:hover {\
      background-position: -989px 0px;\
}\
\
      #ImperatorOverviewBuildingsTable th.building_architect { \
        background-image: url("/cdn/all/both/buildings/buildingbutton_sprite.jpg");\
        background-position: -1032px -41px;\
        background-repeat: no-repeat;\
        background-size: auto;\
        width: 43px;\
        height: 43px;\
...
\
      #ImperatorOverviewBuildingsTable th.building_architect:hover {\
      background-position: -1032px 0px;\
}\
      #ImperatorOverviewBuildingsTable th.building_temple { \
        background-image: url("/cdn/all/both/buildings/buildingbutton_sprite.jpg");\
        background-position: -1075px -41px;\
        background-repeat: no-repeat;\
        background-size: auto;\
        width: 43px;\
        height: 43px;\
...
\
      #ImperatorOverviewBuildingsTable th.building_temple:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_pirateFortress:hover {\
...
\
      #ImperatorOverviewBuildingsTable th.building_blackMarket:hover {\
      background-position: -1204px 0px;\
}\
      #ImperatorOverviewBuildingsTable th.building_marineChartArchive { \
        background-image: url("/cdn/all/both/buildings/buildingbutton_sprite.jpg");\
        background-position: -1247px -41px;\
        background-repeat: no-repeat;\
        background-size: auto;\
        width: 43px;\
        height: 43px;\
...
\
      #ImperatorOverviewBuildingsTable th.building_marineChartArchive:hover {\
      background-position: -1247px 0px;\
}\
      #ImperatorOverviewBuildingsTable th.building_dockyard { \
        background-image: url("/cdn/all/both/buildings/buildingbutton_sprite.jpg");\
        background-position: -1290px -41px;\
        background-repeat: no-repeat;\
        background-size: auto;\
        width: 43px;\
        height: 43px;\
...
\
      #ImperatorOverviewBuildingsTable th.building_dockyard:hover {\
      background-position: -1290px 0px;\
}\
      #ImperatorOverviewBuildingsTable th.building_shrineOfOlympus { \
        background-image: url("/cdn/all/both/buildings/buildingbutton_sprite.jpg");\
        background-position: -1333px -41px;\
        background-repeat: no-repeat;\
        background-size: auto;\
        width: 43px;\
        height: 43px;\
...
\
      #ImperatorOverviewBuildingsTable th.building_shrineOfOlympus:hover {\
...
'
          ...
          if (window.webkitNotifications) {
            if (window.webkitNotifications.checkPermission() == 0) { // PERMISSION_ALLOWED
              var notification = window.webkitNotifications.createNotification(
                  'http://' + document.domain + '//cdn/all/both/layout/advisors/general_alert.png', 
  ...
  function overviewTables() {
        ...
        function makeResearchCell(city) {
          ...
          if (academy) {
            ...
            toolTips.registerSimple(link.getId(),
                makeResourceUseToolTip('/cdn/all/both/layout/bulb-on.png',
        ...
        function makePopulationCells(city) {
          ...
          toolTips.registerRefreshable(updateable.getId(4), function() {
            ...
            return makeResourceUseToolTip(
                data.happiness >= 0 ? '/cdn/all/both/icons/growth_positive.png'
        ...
        function makeTotalsRow(cities) {
          ...
          function makeResearchCell(cities) {
            ...
            toolTips.registerSimple('ResearchTotal',
                makeResourceUseToolTip(
                    '/cdn/all/both/layout/bulb-on.png', rows, footer));
      ...
      var BUILDING_ORDER = [
        ...
        { name: 'trading', 
          buildings: [IkaTools.Constants.Buildings.WAREHOUSE,
                      ...
                      IkaTools.Constants.Buildings.DOCK_YARD,
                      IkaTools.Constants.Buildings.SHRINE_OF_OLYMPUS,
    ...
    var leftMenuResourceContent = 
        $(('<li>' + 
            '<div class="image" ' + 
                 'style="background-image: url(\'/cdn/all/both/minimized/resourceShop.png\'); ' +
    ...
    var leftMenuBuildingsContent = 
        $(('<li>' + 
           '<div class="image" ' + 
                'style="background-image: url(\'/cdn/all/both/layout/btn_city.png\'); ' +
    ...
    var leftMenuArmyContent = 
        $(('<li>' + 
            '<div class="image" ' + 
                 'style="background-image: url(\'/cdn/all/both/characters/military/x40_y40/y40_phalanx_faceright.png\'); ' +
    ...
    var leftMenuEspionageContent = 
        $(('<li>' + 
            '<div class="image" ' + 
                 'style="background-image: url(\'/cdn/all/both/characters/military/120x100/spy_120x100.png\'); ' +
        ...
        IkaTools.Utils.iterateIkariamAjaxResponse(response, function(index, name, data) {
          if (name == IkaTools.Constants.IkariamAjaxResponseType.UPDATE_GLOBAL_DATA) {
            ...
            if (data.headerData.advisors.military.cssclass.indexOf('normalalert') >= 0) {
              ...
              if (!underAttack) {
                showDesktopNotification('http://' + document.domain + '//cdn/all/both/layout/advisors/general_alert.png', 
...
GM_addStyle(`
  ...
  .imperator_overview th,
  .imperator_overview td,
  #ImperatorOverviewResourceTable th,
  #ImperatorOverviewResourceTable td,
  #ImperatorOverviewBuildingsTable th,
  #ImperatorOverviewBuildingsTable td,
  #ImperatorOverviewMilitaryTable th,
  #ImperatorOverviewMilitaryTable td,
  #ImperatorOverviewEspionageTable th,
  #ImperatorOverviewEspionageTable td {
    padding: 4px 6px;
    text-align: center;
    min-width: 40px;
  }

  .imperator_overview th:first-child,
  .imperator_overview td:first-child {
    text-align: left;
    min-width: 120px;
  }

  .imperator_overview thead {
    position: sticky;
    top: 0;
