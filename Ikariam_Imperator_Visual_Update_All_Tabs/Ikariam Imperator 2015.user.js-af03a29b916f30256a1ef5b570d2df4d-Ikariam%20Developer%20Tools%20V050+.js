...
IkaTools = (function() {
  ...
  var Constants = {
    ...
    Movements: {
      ...
      MissionData: {
        transport: {
          icon: '/cdn/all/both/interface/mission_transport.png',
        },
        deployarmy: {
          icon: '/cdn/all/both/interface/mission_deployarmy.png',
        },
        deployfleet: {
          icon: '/cdn/all/both/interface/mission_deployfleet.png',
        },
        plunder: {
          icon: '/cdn/all/both/interface/mission_plunder.png',
        },
        piracyRaid: {
          icon: '/cdn/all/both/interface/mission_piracyRaid.png',
        },
      }
    },
    ...
    BuildingData: {
      ...
      warehouse: {
        ...
        icon  :'/cdn/all/both/buildings/buildingbutton_sprite.jpg',
      },
      winegrower: {
        maxLevel: 32,
        wood  :[274, 467, 718, 1045, 1469, 2021, 2738, 3671, 4883, 6459, 8508, 11172, 14634, 19135, 24987, 32594, 42483, 55339, 72050, 93778, 122021, 158740, 206471, 268524, 349194, 454063, 590393, 767620, 998018, 1297535, 1686906, 2193088],
  ...
  var EmpireData = function() {
    ...
    function processCityMilitaryView(data) {
      ...
      var armyTds = $('#tabUnits').find('tr.count td').filter(function() {
      ...
      var navyTds = $('#tabShips').find('tr.count td').filter(function() {
        return /^\d+$/.test($(this).text().trim());
      });
